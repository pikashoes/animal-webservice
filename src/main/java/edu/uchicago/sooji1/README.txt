...
to the entities in your database.
    ...
    Done. Did this with the professor after class. All the commands work, and I have set up a
    separate controller for it. Most of the code is the one posted by the professor in Piazza, as
    instructed. Goes to "localhost:8080/api/"

    I used Postman to check this.

3/ Use Thymeleaf to iterate over a collection on a results page (as seen in SportsVans).
You must have at minimum 2 view pages. The use of headers is optional.

    Done. I again used similar code from SportsVans to iterate over the collection on a results page.
